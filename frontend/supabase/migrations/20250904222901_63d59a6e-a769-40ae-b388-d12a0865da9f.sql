-- Função para buscar dados de projetos sem limitação de registros
...
BEGIN
  ...
  SELECT 
    ...
    cycles.billing_period_start_date,
    cycles.billing_period_end_date
  ...
  ) cycles ON asset.consumption_date >= cycles.billing_period_start_date 
    AND asset.consumption_date <= cycles.billing_period_end_date
